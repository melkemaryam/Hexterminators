...
class Tool:
    ...
    '''
    def rentAnItem(self, databaseFilename):
        ...
        if chooseCategoryRent == 1 or 2 or 3 or 4 or 5:
            ...
            cursor = DatabaseConnection.cursor(databaseFilename)
        ...
        printNoteStateOfItem = Notes.Rent(tool_id, descriptionToolInput, databaseFilename)
        ...
        validationD = CheckInputs.dateCheck(tool_id, dateOfBooking)
        while dateOfBooking == "" or validationD == False:
            validationD = CheckInputs.dateCheck(tool_id, dateOfBooking)
            dateOfBooking = input("Please try again. The date format should be (YY-MM-DD)")
    ...
    def returnItem(self, databaseFilename):
        ...
        LateCharge.checkIfLate(book_id, bookingIdReturnInput)
        ...
        Notes.Return(book_id, noteOnReturn)    

    def markAvailability(self, databaseFilename):
            ...
            Notes.Broken(self, maToolInput, brokenNoteInput, databaseFilename)
